...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.addSection(TypeSection.OBJECTIVE, new TextSection("Ведущий стажировок" +
                " и корпоративного обучения по Java Web и Enterprise технологиям"));
        resume.addSection(TypeSection.PERSONAL, new TextSection("Аналитический склад ума," +
        ...
        resume.addSection(TypeSection.ACHIEVEMENT, new TextListSection(achievement));
        ...
        resume.addSection(TypeSection.QUALIFICATIONS, new TextListSection(qualifications));
        ArrayList<InformationSection.Information> experience = new ArrayList<InformationSection.Information>();
        experience.add(new InformationSection.Information("Java Online Projects", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Автор проекта.",
                "Создание, организация и проведение Java онлайн проектов и стажировок."));
        experience.add(new InformationSection.Information("Wrike", new Date(102014), new Date(2010-1900,07,21), "Старший разработчик (backend)", "Проектирование" +
        ...
        experience.add(new InformationSection.Information("RIT Center", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Java архитектор", "\n" +
        ...
        experience.add(new InformationSection.Information("Luxoft (Deutsche Bank)", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Ведущий программист", "Участие" +
        ...
        experience.add(new InformationSection.Information("Yota", new Date(1996-1900,05,4), new Date(10-2013), "Ведущий специалист",
        ...
        experience.add(new InformationSection.Information("Enkata", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Разработчик ПО", "Реализация клиентской" +
                " (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining)."));
        experience.add(new InformationSection.Information("Siemens AG", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Разработчик ПО", "Разработка информационной модели," +
                " проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix)."));
        experience.add(new InformationSection.Information("Alcatel", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Инженер по аппаратному и программному тестированию", "\tИнженер по" +
                " аппаратному и программному тестированию\n" +
                "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM)."));
        resume.addSection(TypeSection.EXPERIENCE, new InformationSection(experience));
        ArrayList<InformationSection.Information> education = new ArrayList<InformationSection.Information>();
        education.add(new InformationSection.Information("Coursera", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Functional Programming Principles in Scala\" by Martin Odersky", ""));
        education.add(new InformationSection.Information("Luxoft", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "\tКурс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", ""));
        education.add(new InformationSection.Information("Siemens AG", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "3 месяца обучения мобильным IN сетям (Берлин)", ""));
        education.add(new InformationSection.Information("Alcatel", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "6 месяцев обучения цифровым телефонным сетям (Москва)", ""));
        education.add(new InformationSection.Information("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и " +
                "оптики", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Аспирантура (программист С, С++)", ""));
        education.add(new InformationSection.Information("Заочная физико-техническая школа при МФТИ", new Date(1996-1900,05,4), new Date(2010-1900,07,21), "Закончил с отличием", ""));
        resume.addSection(TypeSection.EDUCATION, new InformationSection(education));
        resume.addContacts(TypeContacts.PHONE, "+7(921) 855-0482");
        resume.addContacts(TypeContacts.EMAIL, "gkislin@yandex.ru");
        resume.addContacts(TypeContacts.SKYPE, "grigory.kislin");
